...
export IMAGE="negociator_aden_org"
export BUILD_TAG=$(sed -n '1p' /tmp/.negociator_aden_org)
echo BUILD_TAG=$(sed -n '1p' /tmp/.negociator_aden_org) > /home/jenkins/project/negociator_aden_org/.env
PWDD=/home/jenkins/project/negociator_aden_org
